            ...
            <div className={styles.cards}>
                ...
                <div className={styles.summary}>
                    ...
                    <div className={styles.card2}>
                        <div className={`${styles.summaryBar} ${styles.reaction}`}>
                            ...
                            <div className={styles.summaryScore}>
                                <p><span className={styles.summaryBold}>80</span> / 100</p>
                            </div>
                        </div>
                        <div className={`${styles.summaryBar} ${styles.memory}`}>
                            <div className={styles.summaryName}>
                        ...
                        <div className={`${styles.summaryBar} ${styles.verbal}`}>
                            <div className={styles.summaryName}>
                        ...
                        <div className={`${styles.summaryBar} ${styles.visual}`}>
                            <div className={styles.summaryName}>
                    ...
                    <button className={styles.buttonCont}>Continue</button>
                </div>
            </div>
        </main>
    )
